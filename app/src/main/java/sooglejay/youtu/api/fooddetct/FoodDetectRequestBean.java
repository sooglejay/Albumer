...
//    可选	seq	String	标示识别请求的序列号
    ...
    public FoodDetectRequestBean() {
    }

    protected FoodDetectRequestBean(Parcel in) {
    ...
    public static final Creator<FoodDetectRequestBean> CREATOR = new Creator<FoodDetectRequestBean>() {
        public FoodDetectRequestBean createFromParcel(Parcel source) {
            return new FoodDetectRequestBean(source);
        }

        public FoodDetectRequestBean[] newArray(int size) {
            return new FoodDetectRequestBean[size];
        }
    };
}
