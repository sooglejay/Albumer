 ...
 */
public class FoodDetectUtil extends RetrofitUtil {
     ...
     * @param callback
     */
    public static void foodDetct(Context mContext,
                                 String app_id,
                                 String image,
                                 String url,
                                 String seq,
                                 NetCallback<FoodDetectResponseBean> callback) {
        ...
        FoodDetectRequestBean bean = new FoodDetectRequestBean();
        bean.setApp_id(app_id);
        bean.setImage(image);
        bean.setUrl(url);
        bean.setSeq(seq);
        git.fooddetct(bean, callback);
    }
