 ...
 */
public class ImageTagUtil extends RetrofitUtil {
     ...
     * @param callback
     */
    public static void imageTag(Context mContext,
                                String app_id,
                                String image,
                                String url,
                                String seq,
                                NetCallback<ImageTagResponseBean> callback) {
        ...
        ImageTagRequestBean bean = new ImageTagRequestBean();
        bean.setApp_id(app_id);
        bean.setImage(image);
        bean.setUrl(url);
        bean.setSeq(seq);
        git.imagetag(bean, callback);
    }
}
